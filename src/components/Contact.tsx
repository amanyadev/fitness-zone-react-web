...
const Contact = () => {
  ...
  const handleWhatsAppClick = (e: React.MouseEvent) => {
    ...
    const cleanNumber = contactInfo.primaryPhone.replace(/[^0-9]/g, '');
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            >
              ...
              >
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <motion.button
                      onClick={(e) => handlePhoneClick(contactInfo.primaryPhone, e)}
                      className="w-full flex items-start space-x-4 text-left group"
                      whileHover={{ x: 5 }}
                    >
                      <div className="w-12 h-12 bg-yellow-400/20 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:bg-yellow-400/30 transition-colors">
                      ...
                      <div>
                        ...
                        <button
                          onClick={(e) => handlePhoneClick(contactInfo.secondaryPhone, e)}
                          className="text-gray-400 hover:text-yellow-400 transition-colors mt-1"
                        >
              ...
              <motion.button
                variants={itemVariants}
                onClick={handleMapClick}
                className="w-full h-[300px] rounded-2xl overflow-hidden border border-yellow-400/20 relative group"
                whileHover={{ scale: 1.02 }}
              >
                <iframe
