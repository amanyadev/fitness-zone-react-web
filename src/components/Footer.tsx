    ...
    <footer className="bg-black border-t border-orange-500/20 py-12">
      <div className="container mx-auto px-4 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="flex space-x-4">
                <button className="w-10 h-10 bg-gradient-to-r from-orange-500 to-red-500 rounded-full flex items-center justify-center hover:from-orange-600 hover:to-red-600 transition-all duration-300 transform hover:scale-110">
            ...
            {/* Contact Info */}
            <div>
              <h4 className="text-lg font-semibold text-orange-500 mb-4">Contact Info</h4>
          ...
          {/* Bottom Section */}
          <div className="border-t border-orange-500/20 mt-8 pt-8 flex flex-col md:flex-row items-center justify-between">
